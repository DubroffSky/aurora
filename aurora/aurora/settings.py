...
SECRET_KEY = 'django-insecure-q61)-8^%!s&*_=r+pe3ws&!4=*(&zl_#gf$tmtoeq^dca!g)p8'
...
# Email settings
EMAIL_BACKEND = 'django.core.mail.backends.console.EmailBackend'  # For development - displays email in the console
